...
function reset(Circuit1){
    ...
    PartEleCount = 17; // number of fields per particle in the state array
...
var PartEleCount = 17; // number of fields per particle in the state array
...
function makeCircuitWalls() {
  // create four points on the outside, color them green
  circWalls = new Float32Array(6*numComps*PartEleCount); // 4 triangles (3 verts each) per circuit component
  manOffset = 0;
  negy = 1;
  negx = 1;
  ...
  for (i = 0; i < Circuit.length; i++) {
    ...
    if (Math.abs(endx - startx) > Math.abs(endy - starty)){
        if (endx > startx){ var negx = 1;}else{ var negx = -1; }
          //bottom wall
          circWalls[manOffset+P_POSX] = startx-0.2*negx, circWalls[manOffset+P_POSY] = starty +0.2, circWalls[manOffset+P_POSZ] = 0.2;
          ...
          manOffset += PartEleCount;
          circWalls[manOffset+P_POSX] = endx+0.2*negx, circWalls[manOffset+P_POSY] = endy  +0.2, circWalls[manOffset+P_POSZ] = 0.2;
          circWalls[manOffset+P_CRED] = r1, circWalls[manOffset+P_CBLU] = g1,circWalls[manOffset+P_CGRN] = b1;
      ...
      circWalls[manOffset+P_POSX] = startx-0.2, circWalls[manOffset+P_POSY] = starty +0.2* negy, circWalls[manOffset+P_POSZ] = 0.2;
      circWalls[manOffset+P_CRED] = r1, circWalls[manOffset+P_CBLU] = g1,circWalls[manOffset+P_CGRN] = b1;
      manOffset += PartEleCount;

      circWalls[manOffset+P_POSX] = startx -0.2, circWalls[manOffset+P_POSY] = endy  +0.2* negy, circWalls[manOffset+P_POSZ] = 0.2;
      circWalls[manOffset+P_CRED] = r1, circWalls[manOffset+P_CBLU] = g1,circWalls[manOffset+P_CGRN] = b1;
      manOffset += PartEleCount;

      circWalls[manOffset+P_POSX] = endx+0.2, circWalls[manOffset+P_POSY] = starty  -0.2* negy, circWalls[manOffset+P_POSZ] = 0.2;
      circWalls[manOffset+P_CRED] = r1, circWalls[manOffset+P_CBLU] = g1,circWalls[manOffset+P_CGRN] = b1;
      manOffset += PartEleCount;
      ...
      circWalls[manOffset+P_POSX] = endx+0.2, circWalls[manOffset+P_POSY] = endy -0.2* negy, circWalls[manOffset+P_POSZ] = 0.2;
      circWalls[manOffset+P_CRED] = r1, circWalls[manOffset+P_CBLU] = g1,circWalls[manOffset+P_CGRN] = b1;
      manOffset += PartEleCount; 
    ...
    for (j = 0; j < 6; j++) {
      ...
      var offset = j*PartEleCount + i*PartEleCount*6;
      circWalls[offset+P_MASS] = 100000;
      circWalls[offset+P_SIZE] = 1;
      // positions will be added manually  
      circWalls[offset+P_VELX] = 0;
